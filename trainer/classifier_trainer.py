...
class ClassifierTrainer:
    def __init__(self
        ...
        self.evaluator \
            = DicomSeriesEvaluator(self.device, self.data_manager.get_valid_dataloader(), ClassifierAccuracyCalculator())
    ...
    def train(self, model: torch.nn.Module):
        ...
        self.best_checkpoint_name \
            = f'best_checkpoint_{type(self.model).__name__.lower()}_{self.data_manager.current_fold:02d}_{self.train_start_time_str}.pth'
