...
from evaluator import VesselSegmentEvaluator


class VesselSegmentTrainer:
    def __init__(self
                #  , cfg: DictConfig
                 , fold_index: int
                 , fp16: bool
        ...
        self.criterion = criterion.bce.to(self.device)

        self.evaluator \
            = VesselSegmentEvaluator(self.device, self.data_manager.get_valid_dataloader())
